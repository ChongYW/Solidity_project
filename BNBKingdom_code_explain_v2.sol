...
// CYW: Only admin can blacklist the target wallet?
    function blackListWallet(address Wallet, bool isBlacklisted) public{
        require(msg.sender == owner(), "Admin use only.");
        Blacklisted[Wallet] = isBlacklisted;
    }

// CYW: Only admin can blacklist the multiple target wallet?
...
// CYW: Only admin can check is the target wallet blacklist status?
...
// CYW: Return the related information after done some calculations?
